...
public class CarConfiguration {
	...
	//****************** Newly add **************//
	private static String oddEvenType = "normal";
	//*******************************************//
	...
	//************************** Newly add part **************//
	public static String getOddEvenType() {
		return oddEvenType;
	}

	public static void setOddEvenType(String oddEvenType) {
		CarConfiguration.oddEvenType = oddEvenType;
	}
